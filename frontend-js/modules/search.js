...
export default class Search {
    ...
    keyPressHandler() {
        ...
        if (value != "" && value != this.previousValue) {
            ...
            this.showLoaderIcon();
            this.hideResultsArea();
            this.typingWaitTimer = setTimeout(() => this.sendRequest() , 1500);
        }
    ...
    renderResultsHTML(posts) {
        if (posts.length) {
            ...
            this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">Sorry, there were no journal results</p>`
        }
        this.hideLoaderIcon()
